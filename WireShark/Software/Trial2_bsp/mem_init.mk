...
MEM_0 := Wire_Shark_descriptor_memory
...
MEM_1 := Wire_Shark_onchip_memory_nios
$(MEM_1)_NAME := onchip_memory_nios
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory_nios
$(MEM_1)_WIDTH := 32
...
onchip_memory_nios: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
