...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL PacketFilter
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file PacketFilter.vhd VHDL PATH PacketFilter.vhd TOP_LEVEL_FILE
...
add_interface_port avalon_slave_0 outData readdata Output 32
add_interface_port avalon_slave_0 inData writedata Input 32
add_interface_port avalon_slave_0 address address Input 4
add_interface_port avalon_slave_0 chipselect chipselect Input 1
add_interface_port avalon_slave_0 readTo read Input 1
add_interface_port avalon_slave_0 writeTo write Input 1
...
add_interface_port avalon_streaming_sink avsChannel data Input 32
