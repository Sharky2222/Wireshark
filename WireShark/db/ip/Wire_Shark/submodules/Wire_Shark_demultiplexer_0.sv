...
//   output_name:        Wire_Shark_demultiplexer_0
//   use_packets:        true
//   use_empty:          1
//   empty_width:        2
//   data_width:         32
...
//   outPayloadWidth:    36
//   outPayloadMap:      out0_data,out0_startofpacket,out0_endofpacket,out0_empty out1_data,out1_startofpacket,out1_endofpacket,out1_empty
//   
// ------------------------------------------


module Wire_Shark_demultiplexer_0 (     
 // Interface: in
 input              in_channel,
 input              in_valid,
 output reg         in_ready,
...
// ---------------------------------------------------------------------
Wire_Shark_demultiplexer_0_1stage_pipeline #( .PAYLOAD_WIDTH( 36 + 1 )) inpipe
 ( .clk      (clk ),
   .reset_n  (reset_n  ),
   .in_ready (in_ready_wire ),
   .in_valid (in_valid ),
...
always @* begin
   ...
   // ---------------------------------------------------------------------
Wire_Shark_demultiplexer_0_1stage_pipeline #( .PAYLOAD_WIDTH(36)) outpipe0
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs0_ready ),
    .in_valid   (rhs0_valid),
...
Wire_Shark_demultiplexer_0_1stage_pipeline #( .PAYLOAD_WIDTH(36)) outpipe1
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs1_ready ),
    .in_valid   (rhs1_valid),
...
//  --------------------------------------------------------------------------------
module Wire_Shark_demultiplexer_0_1stage_pipeline
